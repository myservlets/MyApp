 ...
 */
public class WaitRefundGoodsAdapter extends RecyclerView.Adapter<WaitRefundGoodsAdapter.ViewHolder> implements View.OnClickListener {
    List<Order> orders;
    ...
    public WaitRefundGoodsAdapter(List<Order> orders){ this.orders = orders; }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_wait_refund,viewGroup,false);
