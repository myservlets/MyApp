 ...
 */
public class WaitReceiveGoodsAdapter extends RecyclerView.Adapter<WaitReceiveGoodsAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public WaitReceiveGoodsAdapter(List<Order> orders){ this.orders = orders; }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_wait_receive,viewGroup,false);
        ...
        viewHolder.whereGoods = view.findViewById(R.id.where_goods);
        viewHolder.confirm = view.findViewById(R.id.confirm_order);
        viewHolder.whereGoods.setOnClickListener(this);
